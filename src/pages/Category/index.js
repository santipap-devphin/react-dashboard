...
class CategoryComponent extends Component {
  ...
  loaddata = async () => {
    ...
    const res = await fetch(`https://zio666.com/endpoint_content/load_category.php`)
  ...
  onFinish = (values) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        axios({
          method: 'post',
          url: 'https://zio666.com/endpoint_content/insert_category.php',
          data: formDatas,
          dataType:'json',
  ...
  deleteContent = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
                  ...
                  axios({
                  method: 'post',
                  url: 'https://zio666.com/endpoint_content/delete_category.php',
                  data:formDatas,
                  //dataType:'json',
                  config: { headers: {'Content-Type': 'multipart/form-data' }}
                  })
      ...
      },
      {
        ...
        render: (text, record) => (
          <Space size="small">
            ...
            {record.count == 0 ? <Button type="primary" onClick={() => this.deleteContent(record.id)} danger>Delete</Button> :<Button disabled={true} type="primary" onClick={() => this.deleteContent(record.id)} danger>Delete</Button>}
